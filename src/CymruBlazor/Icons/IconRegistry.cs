...
public static class IconRegistry
{
    private static readonly Dictionary<string, string> Icons = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "stethoscope", "<path d=\"M4.5 3h2\" /> <path d=\"M5.5 3v4a3 3 0 0 0 6 0V3\" /> <path d=\"M6.5 3h2\" /> <path d=\"M8.5 10v4a5 5 0 0 0 10 0v-4\" /> <circle cx=\"18.5\" cy=\"9.5\" r=\"1.5\" />" },
